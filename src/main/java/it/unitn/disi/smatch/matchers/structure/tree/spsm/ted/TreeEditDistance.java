...
public class TreeEditDistance {
     ...
     * determined by comparator.
     */
    private double weightSubstitute = DEFAULT_WEIGHT_SUBSTITUTE;

    /**
     * Default weight of substitute operation for equal objects. Equality is
     * determined by comparator.
     */
    private double weightSubstituteEqual = DEFAULT_WEIGHT_SUBSTITUTE_EQUAL;
    ...
    public TreeEditDistance(IContext tree1,
        ...
        this(tree1, tree2, comparator, conversion,
                ...
                DEFAULT_WEIGHT_DELETE, DEFAULT_WEIGHT_SUBSTITUTE);
    }
     ...
     * pathLengthLimit argument. Manipulate the weight assigned with transitions
     ...
     * </p>
     * <p/>
     * Any of pathLengthLimit and the weight arguments can be null upon which
    ...
    public double getTreeEditDistance() throws NullPointerException {
        if (!isCalculated()) {
            throw new NullPointerException("Instance did not successfully calculate!");
        }
